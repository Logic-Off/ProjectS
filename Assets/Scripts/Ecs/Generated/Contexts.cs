...
public partial class Contexts
{
	...
	{
		Game.AddEntityIndex(new JCMG.EntitasRedux.PrimaryEntityIndex<GameEntity, Ecs.Common.Id>(
			Id,
			Game.GetGroup(GameMatcher.Id),
			(e, c) => ((Ecs.Common.IdComponent)c).Value));
		Structure.AddEntityIndex(new JCMG.EntitasRedux.PrimaryEntityIndex<StructureEntity, Ecs.Common.Id>(
			Id,
			Structure.GetGroup(StructureMatcher.Id),
			(e, c) => ((Ecs.Common.IdComponent)c).Value));

		Game.AddEntityIndex(new JCMG.EntitasRedux.PrimaryEntityIndex<GameEntity, string>(
			Name,
			Game.GetGroup(GameMatcher.Name),
			(e, c) => ((Ecs.Common.NameComponent)c).Value));
		Structure.AddEntityIndex(new JCMG.EntitasRedux.PrimaryEntityIndex<StructureEntity, string>(
			Name,
			Structure.GetGroup(StructureMatcher.Name),
			(e, c) => ((Ecs.Common.NameComponent)c).Value));
	}
}
...
{
	public static GameEntity GetEntityWithId(this GameContext context, Ecs.Common.Id Value)
	{
		return ((JCMG.EntitasRedux.PrimaryEntityIndex<GameEntity, Ecs.Common.Id>)context.GetEntityIndex(Contexts.Id)).GetEntity(Value);
	}

	public static StructureEntity GetEntityWithId(this StructureContext context, Ecs.Common.Id Value)
	{
		return ((JCMG.EntitasRedux.PrimaryEntityIndex<StructureEntity, Ecs.Common.Id>)context.GetEntityIndex(Contexts.Id)).GetEntity(Value);
	}
	...
	public static StructureEntity GetEntityWithName(this StructureContext context, string Value)
	{
		return ((JCMG.EntitasRedux.PrimaryEntityIndex<StructureEntity, string>)context.GetEntityIndex(Contexts.Name)).GetEntity(Value);
	}
}
//------------------------------------------------------------------------------
// <auto-generated>
